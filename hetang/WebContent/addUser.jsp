    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="center-block" style="width: 700px">
          <form role="form" method="POST" action="CreateUser" style="padding-top: 20px; font-size: 20px;">
            ...
            <div class="form-group">
              <label>用户状态</label> <label class="checkbox-inline"> <input type="radio" name="state" value="0" checked class="input-lg">
                封锁
...
<script type="text/javascript">
	$("#main-nav #addUser").addClass("active")
	$("#userType").select2()
</script>
</html>